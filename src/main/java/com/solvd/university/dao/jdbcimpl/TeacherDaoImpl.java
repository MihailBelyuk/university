...
public class TeacherDaoImpl implements ITeacherDao {
    ...
    private static final String FIND_ALL = "select t.id as teacher_id," +
            "t.first_name as teacher_first_name, t.last_name as teacher_last_name,t.salary as teacher_salary," +
            "t.birthday as teacher_birthday, t.academic_status as teacher_academic_status,a.id as address_id, a.city, " +
            "a.street, a.house, a.flat, a.post_index from teachers t left join addresses a on t.addresses_id=a.id";
